...
test('> Check add button tooltip on hover and menu on click', async ({ mainPage }) => {
...
test('> Check notification button tooltip on hover and popup on click', async ({ mainPage }) => {
...
test('> Check safe mode button tooltip on hover', async ({ mainPage }) => {
  await mainPage.hoverSafeModeButton();
  await mainPage.headerSafeModeButtonSnapshot();
});

test('> Check full menu elements avaliable', async ({ mainPage }) => {
